...
CREATE TABLE DT40903.CONFIG_HCP
(
...
insert into dt40903.CONFIG_DASD values(2,'jdbcDriver',0,'com.ibm.as400.access.AS400JDBCDriver');
insert into dt40903.CONFIG_DASD values(2,'jdbcURL',0,'jdbc:as400://10.193.204.19;naming=system;errors=full');
insert into dt40903.CONFIG_DASD values(2,'dbUserId',0,'DT40903');
insert into dt40903.CONFIG_DASD values(2,'dbPwd',1,'p1e4vIsFCMxe3vuIeMrMwQ==');
insert into dt40903.CONFIG_DASD values(2,'schema',0,'DT40903');
insert into dt40903.CONFIG_DASD values(2,'tableNm',0,'DEST_DASD');
insert into dt40903.CONFIG_DASD values(2,'bgnDestId',0,'A');
insert into dt40903.CONFIG_DASD values(2,'provRetrieveCnt',2,'1');
insert into dt40903.CONFIG_DATA values(2,'hcpTenant',0,'LINCDEV');
insert into dt40903.CONFIG_DATA values(2,'hcpNameSpace',0,'IMAGES');
insert into dt40903.CONFIG_DATA values(2,'hcpRepository',0,'pdc-hcpdev.dstcorp.net/rest/Greg/Test/seven');
insert into dt40903.CONFIG_DATA values(2,'hcpValidHosts',0,'dstcorp.net');
insert into dt40903.CONFIG_DATA values(2,'hcpUserId',0,'Admin');
insert into dt40903.CONFIG_DATA values(2,'hcpPwd',1,'FVPAL1LFwY3key1exEaJ2Q==');
insert into dt40903.CONFIG_DATA values(2,'trustStorePath',0,'D:\\HCP_Testing\\Certs\\hcpdev.jks');
insert into dt40903.CONFIG_DATA values(2,'trustStorePwd',1,'uMNj3VvxvGeB4Rw2HTEMnw==');



insert into dt40903.DEST_HCP values('0001','A','D:\AFTGETS\AFT_IMAGES\tst1.tif','B', '/GroupA/tst1.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0002','A','D:\AFTGETS\AFT_IMAGES\tst2.tif','B', '/GroupA/tst2.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0003','A','D:\AFTGETS\AFT_IMAGES\tst3.tif','B', '/GroupA/tst3.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0004','A','D:\AFTGETS\AFT_IMAGES\tst4.tif','B', '/GroupA/tst4.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0005','A','D:\AFTGETS\AFT_IMAGES\tst5.tif','B', '/GroupA/tst5.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0006','A','D:\AFTGETS\AFT_IMAGES\tst6.tif','B', '/GroupA/tst6.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0007','A','D:\AFTGETS\AFT_IMAGES\tst7.tif','B', '/GroupA/tst7.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0008','A','D:\AFTGETS\AFT_IMAGES\tst8.tif','B', '/GroupA/tst8.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0009','A','D:\AFTGETS\AFT_IMAGES\tst9.tif','B', '/GroupA/tst9.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0010','A','D:\AFTGETS\AFT_IMAGES\tst10.tif','B','/GroupA/tst10.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0011','A','D:\AFTGETS\AFT_IMAGES\tst11.tif','B','/GroupA/tst11.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0012','A','D:\AFTGETS\AFT_IMAGES\tst12.tif','B','/GroupA/tst12.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0013','A','D:\AFTGETS\AFT_IMAGES\tst13.tif','B','/GroupA/tst13.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0014','A','D:\AFTGETS\AFT_IMAGES\tst14.tif','B','/GroupA/tst14.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0015','A','D:\AFTGETS\AFT_IMAGES\tst15.tif','B','/GroupA/tst15.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0016','A','D:\AFTGETS\AFT_IMAGES\tst16.tif','B','/GroupA/tst16.tif','N',null,null,null,null,null,null);
insert into dt40903.DEST_HCP values('0017','A','D:\AFTGETS\AFT_IMAGES\tst17.tif','B','/GroupA/tst17.tif','N',null,null,null,null,null,null);
