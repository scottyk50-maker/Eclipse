...
update DEST_HCP set PROCFLAG='N', NBYTDC = null, CHECKSUM=null, response_cd=null, response_msg=null,UPLOAD_TM=null,end_tm=null;
...
CREATE TABLE DT40903.CONFIG_DATA (
CONFIG_ID INT NOT NULL,
DATANAME CHAR(16) CCSID 37 NOT NULL ,
DATATYPE INT NOT NULL,
DATAVALUE CHAR(128) CCSID 37 NOT NULL ,
CONSTRAINT DT40903.PK_CONFIG_DATA PRIMARY KEY(CONFIG_ID, DATANAME) ) ;

insert into dt40903.CONFIG_DATA values(0,'threadCount',2,'1');
insert into dt40903.CONFIG_DATA values(0,'providerSleep',3,'5000');
insert into dt40903.CONFIG_DATA values(0,'providerClass',0,'com.dstsystems.bps.cfw.frameimplementations.PopulateItemsWithLocators');
insert into dt40903.CONFIG_DATA values(0,'consumerClass',0,'com.dstsystems.bps.cfw.frameimplementations.DASD2DASD');

insert into dt40903.CONFIG_DATA values(1,'dbServer',0,'10.193.204.19');
insert into dt40903.CONFIG_DATA values(1,'dbUserId',0,'DT40903');
insert into dt40903.CONFIG_DATA values(1,'dbPwd',1,'AmFES8yvVEyxlWipezh6hw==');
